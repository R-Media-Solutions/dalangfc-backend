                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-light">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo lang('menu_about_detail_list'); ?></li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0"><?php echo lang('menu_about_detail_list') ?> </h3>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <div class="table-container">
                        ...
                        -->
                        <table class="table align-items-center table-flush" id="list_table_aboutushistory" data-url="<?php echo base_url('aboutus/aboutushistorylistsdata'); ?>">
                            <thead class="thead-light">
                                <tr role="row" class="heading">
                                    <th scope="col" style="width: 10px">#</th>
                                    <th scope="col" class="text-center"><?php echo lang('name'); ?></th>
                                    <th scope="col" class="text-center"><?php echo lang('about_history_date_from'); ?></th>
                                    <th scope="col" class="text-center"><?php echo lang('about_history_date_thru'); ?></th>
                                ...
                                <tr role="row" class="filter" style="background-color: #f6f9fc">
                                    ...
                                    <td class="px-1">
                                        <select name="search_year_from" class="form-control form-control-sm form-filter">
                                            ...
                                            <?php
                                                ...
                                                if( !empty($years) ){
                                                    foreach($years as $b){
                                                        $selected = '';
                                                        echo '<option value="'.$b->kode.'" '.$selected.'>'.$b->nama.'</option>';
                                                    }
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <td class="px-1">
                                        <select name="search_year_thru" class="form-control form-control-sm form-filter">
                                            <option value=""><?php echo lang('select'); ?>...</option>
                                            <?php
                                                $years      = an_year();
                                                if( !empty($years) ){
                                    ...
                                    <td style="text-align: center;">
                                        <button class="btn btn-sm btn-block btn-outline-default btn-tooltip filter-submit" id="btn_list_table_abouthistory" title="Search"><i class="fa fa-search"></i></button>
