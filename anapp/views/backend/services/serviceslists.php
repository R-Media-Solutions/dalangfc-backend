                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-light">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo lang('menu_services_new'); ?></li>
                        </ol>
                    </nav>
                </div>
                <?php if ( $is_admin || $is_member ) { ?>
                    <div class="col-lg-6 col-5 text-right">
                        <a href="<?php echo base_url('services/servicesnew') ?>" class="btn btn-sm btn-outline-default"><i class="fa fa-plus mr-1"></i> <?php echo lang('menu_services_new'); ?></a>
                    </div>
                <?php } ?>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0"><?php echo lang('menu_services_new') ?> </h3>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <div class="table-container">
                        ...
                        -->
                        <table class="table align-items-center table-flush" id="list_table_services" data-url="<?php echo base_url('services/serviceslistsdata'); ?>">
                            <thead class="thead-light">
                                ...
                                <tr role="row" class="filter" style="background-color: #f6f9fc">
                                    ...
                                    <td style="text-align: center;">
                                        <button class="btn btn-sm btn-block btn-outline-default btn-tooltip filter-submit" id="btn_list_table_services" title="Search"><i class="fa fa-search"></i></button>
