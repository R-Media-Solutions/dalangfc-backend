<form role="form" method="post" action="<?php echo base_url('setting/updatecompany'); ?>" id="form-setting-company" class="form-horizontal">
    <div class="card-body wrapper-setting-company">
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-md-9">
                <select class="form-control select_district" name="company_city" id="company_city" data-form="register" data-url="<?php echo base_url('address/selectdistrict'); ?>" data-toggle="select2">
