                                        ...
                                        <div class="col-xl-8 order-xl-2 pt-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge input-group-alternative">
                                                    ...
                                                    <input type="text" name="short_description" id="short_description" class="form-control" placeholder="<?php echo lang('short_description'); ?>" value="<?php echo( $data_product ? $data_product->short_description : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
