                ...
                <div class="col-lg-12 card-wrapper">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <?php if ( $form_page == 'edit' ) { ?>
                                        <a href="<?php echo base_url('home/clientlist') ?>" class="btn btn-sm btn-danger"><span class="fa fa-history"></span> Kembali</a>
                                    <?php } else { ?>
                                        <a href="<?php echo base_url('home/clientlist') ?>" class="btn btn-sm btn-outline-default"><span class="fa fa-list"></span> List Data Pelanggan</a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                        <div class="card-body wrapper-form-client pt-0">
                            <?php 
                                $form_action = base_url('home/saveclient');
                                if ( $form_page == 'edit' ) { 
