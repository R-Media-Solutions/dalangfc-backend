            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h5 class="h3 mb-0 text-capitalize">list <?php echo ( $member->as_stockist > 0 ) ? lang('menu_report_sales') : lang('menu_product'); ?></h5>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody class="list">
                                ...
                                if ( $member->as_stockist > 0 ) {
                                    ...
                                    $link_pending = base_url('productmanage/productlist');
                                }
                                //$data_list  = $this->Model_Shop->get_all_shop_order_data(10, 0, $condition, '');
                                $data_list  = $this->Model_Product->get_all_product(10, 0, $condition, '');
                                if ($data_list) {
                                    foreach ($data_list as $key => $row) {
                                        ...
                                        */
                                        ...
                                        $btn_product    = '<a href="javascript:;" 
                                                            data-url="' . base_url('productmanage/productedit/' . $id_order) . '" 
                                                            class="btn btn-sm btn-block btn-outline-primary btn-shop-order-detail">
                                                            <i class="ni ni-bag-17 mr-1"></i> Detail</a>';
                                        $btn_product    = "";
                                        $type         = '';
            ...
            <div class="modal-content">
                ...
                <form role="form" method="post" action="<?php echo base_url('member/changepassword'); ?>" id="cpassword" class="form-horizontal">
                    <div class="modal-body py-3 wrapper-cpassword" style="background-color: #f8f9fe">
                        ...
                        <p>Selamat datang dan selamat bergabung.</p>
                        <hr class="mt-2">
                        <!-- Current Password  -->
