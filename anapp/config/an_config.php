...
$config['rajaongkir_active']        = TRUE;
$config['rajaongkir_origin']        = 151;
$config['rajaongkir_token']         = '';
$config['rajaongkir_url']           = '';
...
$config['flip_secret']              = '';
$config['flip_url']                 = '';
$config['flip_url_balance']         = '';
$config['flip_url_bank_inquiry']    = '';
$config['flip_sb_url']              = '';
$config['flip_sb_url_bank_inquiry'] = '';
...
$config['fp_merchant']              = '';
$config['fp_merchant_id']           = '';
$config['fp_user_id']               = '';
$config['fp_password']              = '';
$config['fp_password_dev']          = '';
$config['fp_dev_url']               = '';
$config['fp_prod_url']              = '';
...
$config["fp_virtual_account"]       = "";
$config["fp_faspay_key"]            = "";
$config["fp_faspay_secret"]         = "";
$config["fp_app_key"]               = "";
$config["fp_app_secret"]            = "";
$config["fp_client_key"]            = "";
$config["fp_client_secret"]         = "";
$config["fp_iv"]                    = "";
