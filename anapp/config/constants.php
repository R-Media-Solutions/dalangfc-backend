...
if (defined('STDIN')) {
    ...
    if ($_SERVER['SERVER_NAME'] == DOMAIN_NAME) {
        ...
        /*
        define('DOMAIN_SHOP',       "https://rekomen.info"); //input manual
        define('DOMAIN_STORE',      "https://rekomen.store"); //input manual
        define('DOMAIN_NAME_SHOP',  "rekomen.info"); //input manual
        define('DOMAIN_NAME_STORE', "rekomen.store"); //input manual
        */
        define('DOMAIN_SHOP',       ""); //input manual
        define('DOMAIN_STORE',      ""); //input manual
        define('DOMAIN_NAME_SHOP',  ""); //input manual
        define('DOMAIN_NAME_STORE', ""); //input manual
    } else {
        define('DOMAIN_DEV',        TRUE);
        define('DOMAIN_LIVE',       FALSE);
        /*
        define('DOMAIN_SHOP',       "http://rekomendev.info"); //input manual
        define('DOMAIN_STORE',      "http://rekomendev.store"); //input manual
        define('DOMAIN_NAME_SHOP',  "rekomendev.info"); //input manual
        define('DOMAIN_NAME_STORE', "rekomendev.store"); //input manual
        */
        define('DOMAIN_SHOP',       "http://rekomendev.info"); //input manual
        define('DOMAIN_STORE',      "http://rekomendev.store"); //input manual
        define('DOMAIN_NAME_SHOP',  "rekomendev.info"); //input manual
...
define('TBL_ABOUTUS',       'an_page_about');
