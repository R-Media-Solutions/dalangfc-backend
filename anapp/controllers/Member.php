        ...
        */
        ...
        if (!empty($member_list)) {
            ...
            foreach ($member_list as $row) {
                ...
                elseif ( $row->type_status == TYPE_STATUS_MEMBER ){ $status   = '<span class="badge badge-default">'.strtoupper($row->type_status).'</span>'; }
                ...
                $btn_status     = '<a href="'.base_url('member/searchmemberdata/'.$id).'" class="btn btn-sm btn-outline-default btn-tooltip btn-as-status-member" title="Status Member"><i class="fa fa-search"></i></a>';
    ...
    function memberreg()
    {
        ...
        */
        ...
        $data_member            = array(
            ...
            'type'                  => MEMBER,
            'type_status'           => ( $package == 'dropshipper' ? TYPE_STATUS_DROPSHIPPER : TYPE_STATUS_MEMBER ),
            'package'               => $package,
            'rank'                  => $package,
            'sponsor'               => $sponsor_id,
            'parent'                => $upline_id,
        ...
        if ($m_status == 1) {
            ...
            if ($total_omzet_bv > 0) {
                $data_member_omzet    = array(
                    ...
                    'amount'        => $total_price,
                    'status'        => 'register',
                    'desc'          => 'New '.( $package == 'dropshipper' ? 'Dropshipper' : 'Member' ),
