...
// ============================================================
// Form Validation AboutUs Setting
// ============================================================
var FV_AboutUsSetting = function () {    
    // ---------------------------------
    // Handle Validation AboutUs Setting
    // ---------------------------------
    var handleValidationUpdateAboutUsDetail = function() {
        // for more info visit the official plugin documentation: 
        // http://docs.jquery.com/Plugins/Validation

        var form        = $('#form_aboutusdetail_edit');
        var wrapper     = $('.wrapper_aboutusdetail_edit');
        ...
        form.validate({
            ...
            submitHandler: function (form) {
                var url             = $(form).attr('action');
                var aboutusdetail_id        = $('input[name=aboutusdetail_id]', $(form)).val();
                var aboutusdetail_type      = $('input[name=aboutusdetail_type]', $(form)).val();
                var aboutusdetail_title     = $('input[name=aboutusdetail_title]', $(form)).val();
                var aboutusdetail_status    = $('select[name=aboutusdetail_status]', $(form)).val();
                var content_plain   = $('textarea[name=aboutusdetail_content_plain]', $(form)).val();
                var content_email   = CKEDITOR.instances['aboutusdetail_content_email'].getData();

                var data = {
                    'aboutusdetail_id'      : aboutusdetail_id,
                    'aboutusdetail_type'    : aboutusdetail_type,
                    'aboutusdetail_title'   : aboutusdetail_title,
                    'aboutusdetail_status'  : aboutusdetail_status,
                    'content_plain' : content_plain,
                    'content_email' : content_email
                }

                bootbox.confirm('Apakah anda yakin akan edit Detail ini ?', function(result) {
                    if( result == true ){
                        $.ajax({
                            type:   "POST",
                            url:    url,
                            ...
                            success: function( response ){
                                ...
                                if(response.status == 'login'){
                                    ...
                                    if(response.status == 'success'){
                                        var type = 'success';
                                        var icon = 'check';
                                        wrapper  = $('#aboutus_detail_list').parents('.dataTables_wrapper');
                                        $('#modal-form-aboutusdetail').modal('hide');
    ...
    return {
        //main function to initiate the module
        init: function () {
            handleValidationUpdateAboutUsDetail();
        },
    };
}();

// ============================================================
// Form Validation Home Setting
// ============================================================
var FV_HomeSetting = function () {    
    // ---------------------------------
    // Handle Validation Home Setting
    // ---------------------------------
    var handleValidationUpdateHomeDetail = function() {
        // for more info visit the official plugin documentation: 
        // http://docs.jquery.com/Plugins/Validation

        var form        = $('#form_homedetail_edit');
        var wrapper     = $('.wrapper_homedetail_edit');
                            ...
                            success: function( response ){
                                ...
                                if(response.status == 'login'){
                                    ...
                                    if(response.status == 'success'){
                                        var type = 'success';
                                        var icon = 'check';
                                        wrapper  = $('#home_detail_list').parents('.dataTables_wrapper');
                                        $('#modal-form-homedetail').modal('hide');
    ...
    return {
        //main function to initiate the module
        init: function () {
            handleValidationUpdateHomeDetail();
        },
    };
}();