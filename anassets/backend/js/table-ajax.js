...
// =========================================================================
// About Us List Function
// =========================================================================
var TableAjaxAboutUsList = function () {
    var handleRecordsAboutUsList = function() {
        gridTable( $("#aboutus_detail_list") );
    };

    var handleRecordsAboutUsHistoryList = function() {
        gridTable( $("#list_table_aboutushistory") );
    };

    return {
        //main function to initiate the module
        init: function () {
            handleRecordsAboutUsList();
            handleRecordsAboutUsHistoryList();
        }
    };
}();

// =========================================================================
// Services Manage List Function
// =========================================================================
var TableAjaxServicesManageList = function () {
    var handleRecordsServicesManageList = function() {
        gridTable( $("#list_table_services"), false );
    };

    return {
        //main function to initiate the module
        init: function () {
            handleRecordsServicesManageList();
        }
    };
}();
...
// Home List Function
// =========================================================================
var TableAjaxHomeList = function () {
    var handleRecordsHomeList = function() {
        gridTable( $("#home_detail_list") );
    };

    var handleRecordsClientList = function() {
        gridTable( $("#list_table_client") );
    };

    return {
        //main function to initiate the module
        init: function () {
            handleRecordsHomeList();
            handleRecordsClientList();
        }
    };
}();
